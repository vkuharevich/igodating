...
import com.bpcbt.marketplace.boot.chat.service.restrictions.ChatRestrictionsService;
import com.bpcbt.marketplace.boot.chat.service.restrictions.strategy.CheckResponse;
import com.bpcbt.marketplace.boot.commons.util.ExceptionToStringConverter;
import com.bpcbt.marketplace.boot.media.api.connector.MediaServiceConnector;
import com.bpcbt.marketplace.boot.media.api.request.ImageSpecification;
import com.bpcbt.marketplace.boot.media.api.response.SingleImageResponse;
...
import com.bpcbt.marketplace.chat.api.response.CheckRestrictionsResponseShared;
...
import com.bpcbt.marketplace.commons.model.image.ImageExtension;
import com.bpcbt.marketplace.commons.model.image.ImageSize;
