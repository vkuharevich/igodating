...
import com.igodating.boot.commons.NoOpAuthenticationManager;
import com.igodating.boot.commons.properties.ApplicationClientsProperties;
import com.igodating.boot.commons.properties.JwtBackendProperties;
import com.igodating.boot.commons.web.config.ActuatorSecurityConfig;
import com.igodating.boot.commons.web.config.SwaggerSecurityConfig;
import com.igodating.boot.user.api.auth.Http401AuthenticationEntryPoint;
import com.igodating.boot.user.api.auth.JwtBackendAuthenticationFilter;
import com.igodating.boot.user.api.auth.JwtUserAuthenticationFilter;
import com.igodating.chat.api.ChatRoutes;
import com.igodating.commons.util.crypto.CryptoUtils;
