...
public class ChatRestrictionsService {
    ...
    public CheckRestrictionsResponse check(long chatId, CreateMessageRequest request) {
        final List<String> notPassedRestrictionsMessages = restrictions.stream()
                ...
                .toList();
        return notPassedRestrictionsMessages.isEmpty() ? CheckRestrictionsResponse.success() : new CheckRestrictionsResponse(notPassedRestrictionsMessages);
    }
}
