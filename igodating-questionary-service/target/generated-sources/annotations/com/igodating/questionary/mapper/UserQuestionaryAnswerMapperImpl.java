...
@Generated(
    ...
    date = "2025-09-27T14:39:46+0300",
    comments = "version: 1.6.3, compiler: javac, environment: Java 21 (BellSoft)"
)
@Component
public class UserQuestionaryAnswerMapperImpl extends UserQuestionaryAnswerMapper {

    @Override
    public UserQuestionaryAnswer createRequestToModel(UserQuestionaryAnswerCreateDto answer) {
        if ( answer == null ) {
            return null;
        }
        ...
        userQuestionaryAnswer.setQuestionId( answer.questionId() );
        userQuestionaryAnswer.setValue( answer.value() );

        return userQuestionaryAnswer;
    }

    @Override
    public UserQuestionaryAnswer updateRequestToModel(UserQuestionaryAnswerUpdateDto answer) {
        if ( answer == null ) {
            return null;
        }
        ...
        userQuestionaryAnswer.setId( answer.id() );
        userQuestionaryAnswer.setQuestionId( answer.questionId() );
        userQuestionaryAnswer.setValue( answer.value() );
    ...
    @Override
    public UserQuestionaryAnswerView modelToView(UserQuestionaryAnswer answer) {
        if ( answer == null ) {
            return null;
        }
        ...
        userQuestionaryId = answer.getUserQuestionaryId();
        question = questionToQuestionView( answer.getQuestion() );
    ...
    protected QuestionView questionToQuestionView(Question question) {
        if ( question == null ) {
            return null;
        }
